...
type Props = {
	...
	titleReference: Dispatch<SetStateAction<HTMLDivElement | null>>
}

const Presentation: FC<Props> = ( { isTextInScreen, titleReference }) => {
      ...
      <div className={styles.root}>
        <div className='container'>
					<div className='grid' >
						...
						<div className='span-12'>
							<img ref={titleRef} src={'/synth-linewar.png'} className={styles.linewar}/>
						</div>
